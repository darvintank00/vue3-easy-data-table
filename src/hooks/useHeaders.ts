import { ref, Ref, computed, ComputedRef, WritableComputedRef, watchEffect } from 'vue'
...
export default function useHeaders(
  ...
  const headersForRender = ref<HeaderForRender[]>([])
