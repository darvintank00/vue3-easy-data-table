...
const _withScopeId = (n) => (pushScopeId("data-v-35be89f9"), n = n(), popScopeId(), n);
const _hoisted_1 = ["id"];
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emits }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "dd69477c": unref(tableMinHeightPx),
      "198ca6ee": unref(tableHeightPx)
    }));
    const {
      tableNodeId,
      clickEventType,
...
var DataTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-35be89f9"]]);
